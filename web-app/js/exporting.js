...
extend(Chart.prototype, {
	...
	* Export PPT  function
	...
	exportPPT: function(option) {
	  ...
	  //alert(container.URL);
		window.open('../chartExport/export?chartOption='+option+'&exportAction='+document.URL);
	},

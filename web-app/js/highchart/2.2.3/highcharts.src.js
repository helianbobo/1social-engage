...
function Chart(userOptions, callback) {
	...
	function Tooltip(options) {
		...
		function refresh(point) {
			...
			// com.brandtology.shared tooltip, array is sent over
	...
	function MouseTracker(options) {
		...
		function onmousemove(e) {
			...
			// com.brandtology.shared tooltip
	...
	chart.pan = function (chartX) {
		...
		// remove active points for com.brandtology.shared tooltip
		if (hoverPoints) {
			each(hoverPoints, function (point) {
				point.setState();
			});
...
Point.prototype = {
	...
	setState: function (state) {
		...
		if (point.graphic) {
			...
			// if a graphic is not applied to each point in the normal state, create a com.brandtology.shared
...
Series.prototype = {
	...
	render: function () {
		...
		// create one com.brandtology.shared clipRect.
